...
const ReportLost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${url}/items/lost`, data, {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: "url(/path-to-hero-bg.jpg)" }}>
      ...
      >
        <h2 className="text-2xl font-bold text-white mb-6 text-center">Report Lost Item</h2>
        ...
        <button
          type="submit"
          className="w-full py-3 bg-yellow-800 hover:bg-yellow-700 text-white font-bold rounded-full transition-all duration-300"
        >
          Submit
        </button>
